...
### Documentation of code in file app/stations-tdee-calc/page.tsx
...
In this example, the lower triangular matrix has already been created. See separate file for the code used to create the matrix
